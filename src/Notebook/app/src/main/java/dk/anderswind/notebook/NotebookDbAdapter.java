...
public class NotebookDbAdapter {
    ...
    public long updateNote(long idToUdate, String newTitle, String newMessage, Note.Category newCategory)
    {
        ContentValues values = new ContentValues();
        ...
        return sqlDB.update(NOTE_TABLE, values, COLUMN_ID + " == " + idToUdate, null);
    }
    ...
    private static class NotebookDbHelper extends SQLiteOpenHelper
    {
        ...
        public void onUpgrade(SQLiteDatabase sqLiteDatabase, int oldVersion, int newVersion) {
            Log.w(NotebookDbHelper.class.getName(), "Upgrading database from version " + oldVersion + " to " + newVersion);
